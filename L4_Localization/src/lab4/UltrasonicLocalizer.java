...
public class UltrasonicLocalizer implements UltrasonicController, Runnable {
	...
	public void fallingEdge (int distance) {
		...
		Lab4.leftMotor.rotate(convertAngle(2.1, 13.6, TURN_ANGLE), true);
		Lab4.rightMotor.rotate(-convertAngle(2.1, 13.6, TURN_ANGLE), false);
		Lab4.leftMotor.rotate(convertDistance(2.1, 6), true);
		Lab4.rightMotor.rotate(convertDistance(2.1, 6), false);
		Lab4.leftMotor.rotate(-convertAngle(2.1, 13.6, TURN_ANGLE), true);
		Lab4.rightMotor.rotate(convertAngle(2.1, 13.6, TURN_ANGLE), false);
		Lab4.leftMotor.rotate(convertDistance(2.1, 6), true);
		Lab4.rightMotor.rotate(convertDistance(2.1, 6), false);
