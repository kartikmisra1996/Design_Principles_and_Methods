 ...
 * Main class with provided code to run the wall following lab assignment
 * The purpose of this project is to implement the ultrasonic sensors such 
 * that the robot detects a wall and corrects its trajectory to avoid collision
 *
 */
